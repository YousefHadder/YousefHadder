...
-- Tab options (tabclose requires 0.11+, skip in CI)
...
-- Set default border for all floating windows (Neovim 0.11+, skip if not available)
pcall(function() opt.winborder = "rounded" end)
